[![Oleg Kojenets](https://github.com/OlegK333/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/OlegK333/GithubActions/actions/workflows/run-app.yaml)
# Github Actions Lab
